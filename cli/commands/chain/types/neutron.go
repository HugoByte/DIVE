...
func runNeutronWithDefaultServiceConfig(diveContext *common.DiveContext, enclaveContext *enclaves.EnclaveContext) (string, error) {
	...
	params := `{"args":{"data":{}}}`
	nodeServiceResponse, _, err := enclaveContext.RunStarlarkPackage(diveContext.Ctx, "/home/abhishek/Projects/DIVE", common.DiveNeutronDefaultNodeScript, runNeutronNodeWithDefaultConfigFunctionName, params, common.DiveDryRun, common.DiveDefaultParallelism, []kurtosis_core_rpc_api_bindings.KurtosisFeatureFlag{})

...
func RunNeutronWithServiceConfig(diveContext *common.DiveContext, enclaveContext *enclaves.EnclaveContext, data string) (string, error) {
	...
	nodeServiceResponse, _, err := enclaveContext.RunStarlarkPackage(diveContext.Ctx, "/home/abhishek/hugobyte/DIVE", common.DiveNeutronDefaultNodeScript, runNeutronNodeWithDefaultConfigFunctionName, params, common.DiveDryRun, common.DiveDefaultParallelism, []kurtosis_core_rpc_api_bindings.KurtosisFeatureFlag{})
	if err != nil {
		return "", err
	}

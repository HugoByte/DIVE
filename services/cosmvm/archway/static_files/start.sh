...
# init config files
archwayd init archway --chain-id $chainId
...
archwayd add-genesis-account "$addr" 10000000000000000000stake --keyring-backend=test
...
archwayd keys show $key --bech acc --keyring-backend=test

archwayd gentx $key 9500000000000000000stake --commission-rate 0.01 --commission-max-rate 0.1 --commission-max-change-rate 0.1 --pubkey "$(archwayd tendermint show-validator)" --chain-id $chainId --fees 180000000000000000stake --keyring-backend=test

...
$BINARY init neutron --home "$CHAIN_DIR" --chain-id="$CHAINID"
...
$BINARY add-genesis-account "$($BINARY --home "$CHAIN_DIR" keys show $key --keyring-backend test -a)" "100000000000000$STAKEDENOM"  --home "$CHAIN_DIR"
...
sed -i -e "s/minimum-gas-prices = \"\"/minimum-gas-prices = \"0.00$STAKEDENOM,0.00ibc\/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2\"/g" "$CHAIN_DIR/config/app.toml"
